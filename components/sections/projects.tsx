...
const Projects = () => {
  ...
  const projects = [
    {
      title: t('projects.items.socialMediaApi.title'),
      description: t('projects.items.socialMediaApi.description'),
    ...
    {
      title: t('projects.items.travelApp.title'),
      description: t('projects.items.travelApp.description'),
    ...
    {
      title: t('projects.items.ngoWebsite.title'),
      description: t('projects.items.ngoWebsite.description'),
    ...
    {
      title: t('projects.items.authifyApi.title'),
      description: t('projects.items.authifyApi.description'),
    ...
    {
      title: t('projects.items.weatherApi.title'),
      description: t('projects.items.weatherApi.description'),
